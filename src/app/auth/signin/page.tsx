...
const SignIn: React.FC = () => {
  ...
  const handleSignInMutation = useMutation({
    ...
    onSuccess(data, variables, context) {
      toast.success("Sign In Successful", { toastId: "login-successfully" });
      router.push("/");
    },
  ...
  const handleSignIn = async (e: any) => {
    e.preventDefault();
    handleSignInMutation.mutateAsync();
    console.log("Sign In");
  };

  if (handleSignInMutation.isPending) {
    return <Loader />;
  }
