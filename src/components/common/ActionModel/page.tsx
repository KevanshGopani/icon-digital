...
const ActionModel = ({ toggleEditForm, handleDeleteProduct }) => {
  ...
  return (
    <div className="">
      ...
      {isOpen && (
        <div
          ref={modalRef}
          className="absolute -right-8 top-3 z-40 grid h-auto w-[150px] gap-y-3 bg-white p-4 shadow-lg"
        >
          <div
          ...
          >
            ...
            <p className="text-base font-medium text-[#000]">Edit</p>
          </div>
          <div className="flex cursor-pointer items-center gap-x-3">
            ...
            <p className="text-base font-medium text-[#000]">Duplicate</p>
          </div>
          <div
            className="flex cursor-pointer items-center gap-x-3"
          ...
          >
            ...
            <p className="text-base font-medium text-[#f74141]">Delete</p>
          </div>
        </div>
      )}
    </div>
